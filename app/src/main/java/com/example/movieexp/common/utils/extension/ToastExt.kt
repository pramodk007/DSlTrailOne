...
fun Fragment.toast(resId: Int) = (activity ?: context)?.toast(resId)

fun Fragment.toast(text: CharSequence) = (activity ?: context)?.toast(text)

fun Fragment.longToast(resId: Int) = (activity ?: context)?.longToast(resId)

fun Fragment.longToast(text: CharSequence) = (activity ?: context)?.longToast(text)
